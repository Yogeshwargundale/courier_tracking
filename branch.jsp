    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="adminlogin.jsp" class="list-group-item list-group-item-action waves-effect">
 ...
 <!-- Card body -->
    ...
    <div class="card-body">
        ...
        <form method="post" action="branch">
            <p class="h4 text-center py-4">Status Update</p>
           <!-- Material input text -->
            <div class="md-form">
                
                <input type="number" id="materialFormCardConfirmEx" class="form-control" name="cid">
                <label for="materialFormCardConfirmEx" class="font-weight-light">Customer_ID</label>
            </div>
            ...
            <div class="md-form">
                ...
                <input type="text" id="materialFormCardNameEx" class="form-control" name="cl">
                <label for="materialFormCardNameEx" class="font-weight-light">Current Location</label>
            </div>

            <!-- Material input email -->
            <div class="md-form">
                
                <input type="date" id="materialFormCardEmailEx" class="form-control" name="dt" title="enter Date here">
            ...
            <div class="md-form">
                ...
                <input type="time" id="materialFormCardConfirmEx" class="form-control" name="tm" title="enter time here">
            ...
            <div class="md-form">
                ...
                <input type="text" id="materialFormCardPasswordEx" class="form-control" name="st">
                <label for="materialFormCardPasswordEx" class="font-weight-light">Status</label>
            </div>

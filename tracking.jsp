            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="" target="_blank">Track Courier</a>
                        </li>
                        <li class="nav-item">
...
<form action="track" method="post">
    <input type="text" id="inputMDEx" class="form-control" name="tid">
    <label for="inputMDEx">Enter Track Id</label>
    
    
</div> 

<div class="text-center py-4 mt-3">
                <button class="btn btn-cyan" type="submit">Track</button>
            </div>
...
<!--form area-->
    ...
    <footer class="page-footer text-center font-small primary-color-dark darken-2 mt-4 wow fadeIn">
        ...
        <div class="footer-copyright py-3">
            © 2018 Copyright:
            <a href="https://mdbootstrap.com/bootstrap-tutorial/" target="_blank"> yogeshwargundale.wordpress.com </a>
        </div>
        <!--/.Copyright-->
